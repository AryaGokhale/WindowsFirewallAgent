...
void runRule()
{
    ...
    */
    ...
    // Add Filmora to the authorized application collection.
        hr = WindowsFirewallAddApp(
            fwProfile,
            L"%ProgramFiles%\\Wondershare\\Wondershare Filmora (CPC)\\FNativeWebEngineExe.exe",
            L"Wondershare Web Engine"
        );
        if (FAILED(hr))
        {
            printf("Wondershare Web Engine: 0x%08lx\n", hr);
            goto error;
        }
